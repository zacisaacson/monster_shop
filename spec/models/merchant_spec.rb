...
describe Merchant, type: :model do
  ...
  describe 'instance methods' do
    ...
    it 'distinct_cities' do
      ...
      expect(@meg.distinct_cities).to eq(['Rochester', 'New York City']).or eq(['New York City', 'Rochester'])
    end

    it 'pending_orders' do
      order_1 = Order.create!(user_id: @user.id, status: 'cancelled', address_id: @user_address.id)
      order_2 = Order.create!(user_id: @user_1.id, address_id: @user_1_address.id)
      order_3 = Order.create!(user_id: @user.id, address_id: @user_address.id)
      order_1.item_orders.create!(item: @tire, price: @tire.price, quantity: 2)
      order_2.item_orders.create!(item: @chain, price: @chain.price, quantity: 2)
  ...
  describe 'class methods' do
    it 'can get all orders pertaining to a merchant' do
      ...
      user_3_address = user_3.addresses.create!(
        nickname: 'Home',
      ...
      order_3 = user_3.orders.create(address_id: user_3_address.id)
