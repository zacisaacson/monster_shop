...
RSpec.describe 'Merchant dashboard page for merchant employee' do
  before :each do
    @user = User.create!(name: "Gmoney", email: "test1@gmail.com", password: "password123", password_confirmation: "password123")
    ...
    @employee = @mike.users.create!(name: "Gmoney", email: "test@gmail.com", password: "password123", password_confirmation: "password123", role: 1)
